...
import { calculateCardPresentation, performanceLabProducts, type PerformanceLabProduct } from './products';
  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        ...
        <p>이미지가 모두 표시된 뒤 같은 상품의 찜 버튼을 한 번 누르고, Performance와 React Profiler에서 렌더 범위를 확인하세요.</p>
      </header>
