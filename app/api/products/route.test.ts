...
const allProductIds = async (sort: string) => {
  ...
  return [...firstPageBody.products, ...secondPageBody.products].map((product: { id: string }) => product.id);
};
...
describe('GET /api/products', () => {
  ...
  it('matches representative source products across all five image groups', async () => {
    ...
    expect(products.filter((product: { id: string }) => ['p1', 'p6', 'p11', 'p16', 'p21'].includes(product.id))).toMatchObject([
      {
        id: 'p1',
        brand: 'Loopers Select',
        name: '[11월 20일 예약배송] Winter Rocky Pants 2color 윈터 로키팬츠 OG',
  ...
  it('searches explicit brands and source names without case sensitivity', async () => {
    ...
    const body = await response.json();
    expect(body.products.map((product: { id: string }) => product.id)).toEqual(['p16', 'p17', 'p19', 'p20']);
  ...
  it('filters category and sorts popularity deterministically', async () => {
    ...
    const body = await response.json();
    expect(body.products.map((product: { id: string }) => product.id)).toEqual(['p21', 'p22', 'p30', 'p23', 'p25', 'p24']);
    expect(
      body.products
  ...
  it.each([
    ['latest', ['p26', 'p6', 'p27', 'p24', 'p1', 'p28', 'p19', 'p2', 'p29', 'p11', 'p22', 'p3', 'p30', 'p7', 'p16', 'p12', 'p9', 'p15', 'p8', 'p13', 'p4', 'p18', 'p21', 'p5', 'p20', 'p25', 'p10', 'p17', 'p14', 'p23']],
    ['popular', ['p21', 'p11', 'p15', 'p8', 'p22', 'p30', 'p14', 'p18', 'p6', 'p12', 'p23', 'p16', 'p5', 'p25', 'p20', 'p10', 'p1', 'p24', 'p13', 'p7', 'p4', 'p28', 'p2', 'p17', 'p27', 'p9', 'p29', 'p3', 'p19', 'p26']],
    ['price-asc', ['p29', 'p30', 'p25', 'p21', 'p24', 'p15', 'p3', 'p22', 'p2', 'p23', 'p17', 'p20', 'p11', 'p28', 'p14', 'p9', 'p12', 'p19', 'p6', 'p13', 'p26', 'p16', 'p1', 'p10', 'p8', 'p5', 'p4', 'p18', 'p27', 'p7']],
    ['price-desc', ['p7', 'p27', 'p18', 'p4', 'p5', 'p8', 'p10', 'p1', 'p16', 'p26', 'p6', 'p13', 'p19', 'p12', 'p9', 'p14', 'p28', 'p11', 'p20', 'p17', 'p23', 'p2', 'p22', 'p3', 'p15', 'p24', 'p21', 'p25', 'p30', 'p29']]
